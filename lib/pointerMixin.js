...
exports.default = {
  ...
  methods: {
    optionHighlight: function optionHighlight(index) {
      return {
    ...
    optionEval: function optionEval(index, option) {
      return _extends({}, this.optionSelect(option), this.optionHighlight(index));
    },
